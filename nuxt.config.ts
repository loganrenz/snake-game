...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    public: {
      ...
      appUrl: process.env.SITE_URL || 'https://snake-game.pages.dev',
  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { property: 'og:url', content: 'https://snake-game.pages.dev' },
        { property: 'og:site_name', content: 'Snake Game' },
        { property: 'og:image', content: 'https://snake-game.pages.dev/og-image.png' },
        ...
        { name: 'twitter:image', content: 'https://snake-game.pages.dev/og-image.png' },
        { name: 'theme-color', content: '#030712' },
        { name: 'google-site-verification', content: '' }
      ],
      link: [
        { rel: 'canonical', href: 'https://snake-game.pages.dev' }
      ]
    }
  }
})
